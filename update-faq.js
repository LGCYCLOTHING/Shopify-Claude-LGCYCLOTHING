...
const faqHtml = `<style>
.lgcy-faq3-section{position:relative;width:100%;padding:7rem 2rem;box-sizing:border-box;background:linear-gradient(160deg,#1c1c1c 0%,#2a2a2a 40%,#333333 70%,#3d3d3d 100%);display:flex;align-items:center;justify-content:center;}
.lgcy-faq3-inner{position:relative;z-index:1;width:100%;max-width:1000px;}
.lgcy-faq3-header{margin-bottom:2rem;}
.lgcy-faq3-eyebrow{font-family:system-ui,-apple-system,"Helvetica Neue",Arial,sans-serif;font-size:9px;font-weight:900;letter-spacing:0.18em;text-transform:uppercase;color:rgba(255,255,255,0.35);margin:0 0 10px;}
...
.lgcy-faq3-card{background:rgba(255,255,255,0.06);backdrop-filter:blur(24px);-webkit-backdrop-filter:blur(24px);border:1px solid rgba(255,255,255,0.14);border-radius:16px;overflow:hidden;box-shadow:0 8px 32px rgba(0,0,0,0.3),inset 0 1px 0 rgba(255,255,255,0.1);}
...
.lgcy-faq3-item summary:hover{background:rgba(255,255,255,0.04);}
...
.lgcy-faq3-item[open] .lgcy-faq3-chevron{transform:rotate(180deg);background:rgba(255,255,255,0.1);border-color:rgba(255,255,255,0.3);}
...
.lgcy-faq3-answer{padding:0 32px 22px 32px;font-family:system-ui,-apple-system,"Helvetica Neue",Arial,sans-serif;font-size:13px;line-height:1.9;letter-spacing:-0.01em;color:rgba(255,255,255,0.5);font-weight:400;opacity:0;transform:translateY(-4px);transition:opacity 0.3s ease 0.08s,transform 0.3s ease 0.08s;}
...
.lgcy-faq3-answer strong{font-weight:700;color:rgba(255,255,255,0.75);}
